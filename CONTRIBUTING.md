...
3. The pull request should work for Python 3.9.12+, 3.10, 3.11, 3.12, 3.13, and 3.14. Check the GitHub Actions workflow and make sure that the tests pass for all supported Python versions.
