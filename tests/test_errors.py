...
class TestCryptoBotError:
    ...
    def test_cryptobot_error_with_description(self):
        """Test creating CryptoBotError with description."""
    ...
    def test_cryptobot_error_str_representation(self):
        ...
        error_with_desc = CryptoBotError(
            code=400,
            name="BAD_REQUEST",
            description="Invalid parameters"
        )
        assert str(error_with_desc) == "code=400, name=BAD_REQUEST"
    ...
    def test_cryptobot_error_with_none_values(self):
        ...
        error = CryptoBotError(code=None, name=None, description=None)
